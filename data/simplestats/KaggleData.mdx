...
I create a variable called df(stands for dataframe), and I read the CSV file containing insurance information from Kaggle into my variable df (get the URL by watching this video: ([Create URL LINK for your DATA from CSV files](https://youtu.be/jDaWna1IRmY)). 
